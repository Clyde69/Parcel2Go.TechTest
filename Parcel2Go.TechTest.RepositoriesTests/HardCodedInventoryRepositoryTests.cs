...
namespace Parcel2Go.TechTest.Repositories.Tests
{
    ...
    public class HardCodedInventoryRepositoryTests
    {
        ...
        public async Task GetInventoryPricesAsyncTest()
        {
            ...
            expectedResults.Add(InventoryType.ServiceA, new InventoryPrice(InventoryType.ServiceA, new List<Price> { new Price(1, 10), new Price(3, 25) }));
            expectedResults.Add(InventoryType.ServiceB, new InventoryPrice(InventoryType.ServiceB, new List<Price> { new Price(1, 12), new Price(2, 20) }));
